  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="avatarApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="avatarApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('avatarApp.country.countryName')}
              ...
              <ValidatedField
                ...
                name="region"
                data-cy="region"
                label={translate('avatarApp.country.region')}
                type="select"
              >
                <option value="" key="0" />
                {regions
