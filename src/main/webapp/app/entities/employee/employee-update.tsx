  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="avatarApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="avatarApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('avatarApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('avatarApp.employee.lastName')}
                id="employee-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField label={translate('avatarApp.employee.email')} id="employee-email" name="email" data-cy="email" type="text" />
              <ValidatedField
                label={translate('avatarApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('avatarApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('avatarApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('avatarApp.employee.commissionPct')}
              ...
              />
              <ValidatedBlobField
                label={translate('avatarApp.employee.image')}
                id="employee-image"
                name="image"
                data-cy="image"
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('avatarApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('avatarApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
